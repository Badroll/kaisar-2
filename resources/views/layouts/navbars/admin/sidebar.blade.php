<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex flex-column m-0 navbar-brand text-wrap" href="{{ route('admin.dashboard') }}">
      <img src="{{asset('assets/img/logos/logo.png')}}" class="navbar-brand-img h-100" alt="...">
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('admin/profil') ? 'active' : '') }} " href="{{ route('admin.profil') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('admin/users') ? 'active' : '') }}" href="{{ route('users.index') }}">
          <div class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-users {{ (Request::is('admin/users') ? 'text-white' : 'text-dark') }}"></i>
          </div>
      ...
      <!-- Kursus -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('admin/kursus') ? 'active' : '') }}" href="{{ route('kursus.index') }}">
          <div class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-graduation-cap {{ (Request::is('admin/kursus') ? 'text-white' : 'text-dark') }}"></i>
          </div>
      ...
      <!-- Teori -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('admin/teori') ? 'active' : '') }}" href="{{ route('teori.index') }}">
          <div class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-chalkboard-teacher {{ (Request::is('admin/teori') ? 'text-white' : 'text-dark') }}"></i>
          </div>
          <span class="nav-link-text ms-1">Teori</span>
        </a>
      </li>
      <!-- Praktek -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('admin/praktek') ? 'active' : '') }}" href="{{ route('praktek.index') }}">
          <div class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-cut {{ (Request::is('admin/praktek') ? 'text-white' : 'text-dark') }}"></i>
          </div>
          <span class="nav-link-text ms-1">Praktek</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('admin/kelas') ? 'active' : '') }}" href="{{ route('kelas.index') }}">
          <div class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-edit {{ (Request::is('admin/kelas') ? 'text-white' : 'text-dark') }}"></i>
          </div>
          <span class="nav-link-text ms-1">Master Kelas</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('admin/hari-besar') ? 'active' : '') }}" href="{{ route('hari-besar.index') }}">
          <div class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-calendar {{ (Request::is('admin/hari-besar') ? 'text-white' : 'text-dark') }}"></i>
          </div>
          <span class="nav-link-text ms-1">Hari Besar</span>
        </a>
      </li>
    </ul>
  </div>
