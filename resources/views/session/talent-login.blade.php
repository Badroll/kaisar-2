        ...
        <div class="row">
          <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
            <div class="card">
              ...
              <div class="card-body">
                <h4 class="font-weight-bolder text-red">Login Talent</h4>
                <p class="mb-0">Mohon untuk login terlebih dahulu<br></p>
                <form role="form" method="POST" action="{{route('talent.store-login')}}">
                  @csrf
              ...
              <div class="card-footer text-center pt-0 px-lg-2 px-1">
                <small class="text-muted">Lupa password anda? 
                  <a href="/login/forgot-password" class="text-info text-gradient font-weight-bold">here</a>
                </small>
                  <p class="mb-4 text-sm mx-auto">
                    Belum memiliki akun?
                    <a href="{{ route('talent.register') }}" class="text-info text-gradient font-weight-bold">Sign up</a>
                  </p>
                </div>
            </div>
          </div>
